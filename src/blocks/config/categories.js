...
export const BLOCK_CATEGORIES = {
  ...
  architectural: {
    label: 'Architectural',
    types: ['cornice', 'column', 'baluster', 'windowSill', 'chimney', 'buttress', 'finial', 'pediment', 'dentil']
  },
  covers: {
    label: 'Covers',
    types: ['awning', 'pergola', 'tarp', 'umbrella']
  },
  furniture: {
    label: 'Furniture',
    types: ['bench', 'table', 'chair', 'barrel', 'planter', 'ladder', 'stool', 'bed', 'desk']
  },
  storage: {
    label: 'Storage',
    types: ['crate', 'crateOpen', 'crateLarge', 'pallet', 'shelfUnit', 'locker', 'cardboardBox', 'sack', 'bin', 'dumpster']
  },
  industrial: {
    label: 'Industrial',
  ...
  extraShapes: {
    label: 'Extra Shapes',
    types: ['quarterPipe', 'bowl', 'hexagon', 'chamfer', 'gem', 'crystal', 'pill']
  },
  ramps: {
    label: 'Ramps',
