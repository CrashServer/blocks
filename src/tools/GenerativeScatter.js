...
export class GenerativeScatter {
  ...
  updateFromAudio(audioData) {
    ...
    // maxBlocks is set externally via setMaxBlocks() - don't override it here
    // Just modulate other parameters based on audio

    // Bass → scale ratio (more bass = bigger blocks)
